<template>
    <div>
        ...
        <div class="text-white bg-success pt-5 pb-5">
            <div class="container">
                <div class="h1">
                    Privacy Policy for ColliGo
                </div>
                <div>
                    At ColliGo, accessible from colligo.shop, one of our main priorities is the
                    privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by ColliGo and how we use it.
                    <br>
                    ...
                    and/or collect in ColliGo. This policy is not applicable to any information
                ...
                <div>
                    ColliGo follows a standard procedure of using log files. These files log
                    ...
                    the help of the Privacy Policy Generator and the Privacy Policy Template.
                </div>
                <div class="h1">
                ...
                <div>
                    ...
                    advertising partners of ColliGo.
                    <br>
                    Third-party ad servers or ad networks uses technologies like cookies,
                    JavaScript, or Web Beacons that are used in their respective
                    advertisements and links that appear on ColliGo, which are sent directly to
                    ...
                    <br>
                    Note that ColliGo has no access to or control over these cookies that are
                ...
                <div>
                    ColliGo's Privacy Policy does not apply to other advertisers or websites.
                ...
                <div>
                    ...
                    <br>
                    ColliGo does not knowingly collect any Personal Identifiable Information
